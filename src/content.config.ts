...
/**
 * Synthesis content collection. The load-bearing essays of the site:
 * cross-cutting arguments, framings, and positions that the chat
 * agent grounds in via read_essay(). Files at src/content/synthesis/.
 */
